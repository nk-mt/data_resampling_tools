""""
This implementation is taken from here - https://github.com/dialnd/imbalanced-algorithms.
It's slightly extended, so that it calculates the average percentage of the new synth samples for all estimator runs.
"""
